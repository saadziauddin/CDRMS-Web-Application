...
using CDRMS_Web_Application.Views.Account;
...
namespace CDRMS_Web_Application.Views.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<UsersModel> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                TempData["ErrorMessage"] = "User does not exist. Please try again or register.";
